...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    setMessage(true)
    emailjs.sendForm("service_iwwy8vc", "template_oqpu9rd", formRef.current, "XNKiv067SUK5-l83L").then(
      (result) => {
      ...
      <div className="container contact__container">
        <div className="contact__options">
          <article className="contact__option">
            ...
            <h4>Email</h4>
            <h5>ahmedbouafif500@gmail.com</h5>
            <a href="mailto:ahmedbouafif500@gmail.com">Send a message</a>
          </article>
        </div>
